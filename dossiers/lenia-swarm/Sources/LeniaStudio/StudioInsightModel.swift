...
struct StudioMetricDiffPanel: View {
    ...
    var body: some View {
        StudioSurface(title: "Metric Diff", subtitle: "Baseline-normalized comparison table") {
            if rows.isEmpty {
                        ...
                        HStack(spacing: 10) {
                            ...
                            ForEach(Array(entries.enumerated()), id: \.element.id) { index, entry in
                                VStack(alignment: .leading, spacing: 2) {
                                    Text(index == 0 ? "Baseline" : entry.name)
                                        .font(.system(.caption, design: .monospaced, weight: .semibold))
                                ...
                                ForEach(Array(entries.indices), id: \.self) { index in
                                    VStack(alignment: .leading, spacing: 2) {
                                        ...
                                        Text(row.deltaText(at: index))
                                            ...
                                            .foregroundStyle(deltaColor(for: row, at: index))
                                    }
                                    .frame(width: 128, alignment: .leading)
                                }
                            }
    ...
    private func deltaColor(for row: StudioMetricDiffRow, at index: Int) -> Color {
