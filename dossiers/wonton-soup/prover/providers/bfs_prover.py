...
class BFSProverTacticProvider(TacticProvider):
    ...
    def _format_prompt(self, goal: LeanGoal) -> str:
        return f"{self._format_state(goal)}:::"
    ...
    def describe(self) -> str:
        ...
        return f"BFSProverTacticProvider({self._model_id},{mode},samples={self._num_samples})"
