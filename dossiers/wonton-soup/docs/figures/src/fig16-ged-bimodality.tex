...
% Structural drift across solved interventions in the paper cohort
...
\node[annot, anchor=west] at (0, 7.0) {The paper cohort contains no solved reroutes, but most solved recoveries still have non-zero normalized GED.};
