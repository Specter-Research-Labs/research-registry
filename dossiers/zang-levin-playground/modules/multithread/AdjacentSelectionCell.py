...
from .SelectionSortCell import SelectionSortCell


class AdjacentSelectionCell(SelectionSortCell):
    """Selection-style targeting with adjacent-only execution.

    The cell keeps the same ideal-position semantics as SelectionSortCell but may only
    swap one index toward that target per move. This isolates action range from target
    representation.
    """
    ...
    def __init__(
        ...
        self.cell_type = "AdjacentSelection"
