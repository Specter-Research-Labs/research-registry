...
import math
from utils import parse_seed, twenty_points_path
...
cloud_diameters = point_cloud_size_change(twenty_points_path('bubble', SEED))
bubble_monotonicity_change = get_monotonicity_change(twenty_points_path('bubble', SEED))

print(np.corrcoef(cloud_diameters, bubble_monotonicity_change)[0, 1])

selection_cells_cloud_diameters = point_cloud_size_change(twenty_points_path('selection', SEED))
selection_monotonicity_change = get_monotonicity_change(twenty_points_path('selection', SEED))
