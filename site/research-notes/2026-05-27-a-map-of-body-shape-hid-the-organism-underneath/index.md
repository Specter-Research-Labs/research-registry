...
_19–27 May 2026 · Cross-system morphospace analysis. The strongest biological-looking lead remained below its confirmatory threshold._

We wanted one map on which a Flow Lenia organism, an EmbryoMaker embryo and a real fish could at least be discussed in the same geometric language. Each specimen was reduced to twelve measurements of visible form: elongation, compactness, symmetry, coverage, boundary complexity and related properties. The resulting map contained 25,167 Lenia specimens, 859 EmbryoMaker snapshots and 232 fish.
...
One neighborhood of 256 Lenia specimens sat unusually close to the fish collection and showed a larger change in rule state after travelling around closed paths. It was the kind of result that could easily become a headline. The controls did not justify that headline. The combined permutation test reached about 0.094 rather than the stipulated threshold, and none of the five densely tested specimens passed both follow-up controls.
